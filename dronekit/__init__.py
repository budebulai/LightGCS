...
class Version(object):
    ...
    def __str__(self):
        ...
        if(self.vehicle_type == mavutil.mavlink.MAV_TYPE_QUADROTOR):
            prefix += "QUAD-"
        elif(self.vehicle_type == mavutil.mavlink.MAV_TYPE_HEXAROTOR):
            prefix += "HEXA-"
        elif(self.vehicle_type == mavutil.mavlink.MAV_TYPE_OCTOROTOR):
            prefix += "OCTO-"
...
class Vehicle(HasObservers):
    ...
    def __init__(self, handler, gcs_handler):
        super(Vehicle, self).__init__()

        self._handler = handler
        self._master = handler.master
        self._gcs = gcs_handler
...
def connect(ip,
    ...
    vehicle = vehicle_class(handler, gcs_handler)
